  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        rebooked: {
          emerald: "hsl(var(--rebooked-emerald))",
          forest: "hsl(var(--rebooked-forest))",
          mint: "hsl(var(--rebooked-mint))",
        },
        popover: {
      ...
      animation: {
        ...
        "celebration-pop": "celebration-pop 0.7s cubic-bezier(0.34, 1.56, 0.64, 1) forwards",
